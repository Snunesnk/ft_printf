...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/21 15:53:28 by snunes            #+#    #+#             */
/*   Updated: 2019/06/21 16:38:33 by snunes           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int print_char(t_flags *flag, va_list ap)
{
		...
		while (flag->width-- > 1)
			espaces_len++;
		len = espaces_len + 1;
		if (!(espaces = make_espaces(espaces_len)))
			return (-1);
		if (!flag->minus)
